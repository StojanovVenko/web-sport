    ...
    return (
        <div className="jewellery_section">
            <div id="jewellery_main_slider" className="carousel slide" data-ride="carousel">
                                ...
                                <div className="row">
                                    <div className="col-lg-4 col-sm-4">
                                        <div className="box_main">
                                            <h4 className="shirt_text">Jumkas</h4>
                                            <p className="price_text">Start Price <span
                                                style={{color: "f#262626;"}}>$ 100</span></p>
                                            <div className="jewellery_img"><img src="images/jhumka-img.png"/></div>
                                            <div className="btn_main">
                                                <div className="buy_bt"><a href="#">Buy Now</a></div>
                                                <div className="seemore_bt"><a href="#">See More</a></div>
                ...
                <div className={"row"} style={{border: "1px red solid", display: "inline"}}>
                    <a style={{border: "1px red solid", width: "100px", display: "block"}}  className="col-sm-3 carousel-control-prev " href="#jewellery_main_slider" role="button" data-slide="prev">
                        <i className="fa fa-angle-left"/>aaa
                    </a>
                    <a style={{border: "1px red solid", width: "100px", display: "block"}} className="carousel-control-next col-sm-3" href="#jewellery_main_slider" role="button" data-slide="next">
